...
<form method="post" action="">
    ...
    <h2><?php language::printLanguageConstant('HL_LINKBUTTONS'); ?></h2>
    <div class="afltr-acp-list">
            ...
            <?php foreach ($fileList as $file) : ?>
                <tr class="afltr-bg-toggle">
                    <td class="afltr-padding-left afltr-align-left afltr-acp-table-td-top">                        
                        <a target="_blank" class="afltr-file-liste-link afltr-link afltr-link-files afltr-ownbanner-link" href="<?php print basename(base_config::$uploadDir); ?>/<?php print $file->getUrl(); ?>">
                            <img src="<?php print basename(base_config::$uploadDir); ?>/<?php print $file->getUrl(); ?>" alt="<?php print $file->getName(); ?>" <?php print $file->getFileMeta(3); ?>>
                        </a>
                    </td>
